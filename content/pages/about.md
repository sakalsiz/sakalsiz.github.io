...
menu_key: A
icon: "■"
description: Mustafa - founder, builder, data infrastructure, BBS nostalgist. From a small Mediterranean town in Turkey to California, by way of a 14.4k modem.
---

Hey there, fellow traveler.

I'm {yellow}Mustafa{/} - a founder and builder based in California.
I build data infrastructure and developer tools.

## How it started

I grew up in {lightcyan}Alanya{/}, a small town on the Mediterranean
coast of Turkey. There was no internet. There was no software
community. There was a kid with a 386 and a lot of curiosity.

I taught myself {yellow}MS-DOS{/} from books I bought on summer
trips to Ankara. Then {yellow}GW-BASIC{/}. Then {yellow}Pascal{/}.
Then {yellow}C{/}. Then {yellow}x86 assembly{/}. Each one from a
book, each one alone, each one in a bedroom in a coastal town
where nobody else cared about computers.

Then I bought my first {white}modem{/}.

## The modem changed everything

I was in middle school. The modem was 14.4k. I plugged it into the
phone line, dialed a BBS in Ankara, and watched text scroll across
my screen from {lightgreen}someone else's computer{/}, hundreds of
kilometers away.

I was {white}blown away{/}.
...
{lightcyan}HitNet{/}. People across the world on {lightcyan}FidoNet{/}.

It was not the internet. It was better than the internet, in a way.
It was {yellow}small enough to know people by name{/}. Every caller
...
were {green}bridges to other people{/}.

## What I do now

These days I pour that same energy into {green}Peaka{/} - a data
...
{white}making data move between systems that were never designed
to talk to each other{/}.

## Why this site exists

This site is a {yellow}tribute{/}.
...
The technologies from that era had a {white}huge impact on my
life{/}. This site is my way of keeping them alive.

{gray}I still believe the terminal is the most honest interface
ever built.{/}
