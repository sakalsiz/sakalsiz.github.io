...
Most BBSes were public. You dialed in, registered as a new user,
...
A SysOp made a board private for one of a few reasons:

 {lightcyan}▓▓{/} {white}Curated community{/}. They wanted
...
a {lightred}capital offense{/}.

## What "private" actually meant

A typical private BBS had:

 {green}▓▓{/} An {white}unlisted phone number{/}. You learned it
    from someone who already knew it.
 {green}▓▓{/} A {white}closed registration{/}. The new-user prompt
    might say "this BBS is members only - send NetMail to SysOp
    for invitation."
 {green}▓▓{/} {white}Vetted callers{/}. The SysOp called you back
    on a separate voice line to verify you were a real person and
    to gauge whether you fit the board.
 {green}▓▓{/} {white}Multiple access levels{/}. Even after you
    got in, you started at level 10 of 100. Climbing took weeks.
 {green}▓▓{/} {white}A culture of secrecy{/}. Don't share the
    number. Don't repost the files. Don't talk about what was
    talked about.

## The aesthetic

Names of legendary private boards: {lightcyan}The Pit{/}.
{lightcyan}Demon's Forge{/}. {lightcyan}Eternal Damnation{/}.
{lightcyan}The Lair of the Black Dragon{/}. {lightcyan}Last Chance
Cafe{/}. The {white}gothic flourishes{/} were free advertising for
"this is not a casual board, please do not waste our time."

The welcome screens were {yellow}genuine art{/}. Custom ANSI by
...
## Why this culture mattered

Private BBSes were the {white}closed-source{/}, {white}invitation-
...
but the private BBSes knew {green}some things should not be{/}.
