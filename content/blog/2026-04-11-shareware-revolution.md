...
In {yellow}1982{/}, software came in boxes. Shrink-wrapped,
...
{white}Andrew Fluegelman{/} wrote {lightcyan}PC-Talk{/}, a
...
{white}Jim Knopf{/} (writing as Jim Button) did the same thing
with {lightcyan}PC-File{/}, a database. He called it "user-supported
software."

A year later, {white}Bob Wallace{/}, a former Microsoft employee,
released {lightcyan}PC-Write{/} and coined the term that stuck:
{yellow}shareware{/}.

The model was simple. The problem was {lightred}distribution{/}.

## The distribution problem

If your software is free to try, people need a way to get it.
In 1983, the options were:

 {gray}▓▓{/} {white}User group meetings{/}. Local PC clubs passed
    floppies around. Reach: dozens of people per meeting.
 {gray}▓▓{/} {white}Mail order disk vendors{/}. Companies that
 ...
 {gray}▓▓{/} {white}Computer shows{/}. Swap meets and trade shows
...
Shareware needed an infrastructure that was {white}free{/},
{white}fast{/}, and {white}nationwide{/}.

## BBSes were the answer

By the mid-1980s, thousands of BBSes across North America had
{yellow}file areas{/}. Organized directories where callers could
...
path looked like this:
 ...
 {lightcyan}1.{/} Author uploads the ZIP to a few well-known BBSes.
 {lightcyan}2.{/} Callers on those boards download it, try it, and
    upload it to their other favorite boards.
 {lightcyan}3.{/} SysOps see a popular new file and pull it onto
    their boards via FidoNet file requests or by calling other
    boards directly.
 {lightcyan}4.{/} Within days the file is on hundreds of BBSes.
    Within weeks, thousands.

The author paid {white}nothing{/}. The SysOps distributed it
...
{green}voluntary effort{/}.

## Upload/download ratios

Many BBSes enforced {yellow}upload-to-download ratios{/}. You
...
{white}self-curating{/}. Bad software didn't spread because
...
Compare the two models in {yellow}1992{/}:

 {lightred}▓▓{/} {white}Retail box{/}: Publisher pays for packaging,
...
Early shareware had a reputation problem. People assumed free
software was bad software. In {yellow}1987{/}, Jim Knopf and
other authors founded the {white}Association of Shareware
...
The ASP gave shareware {lightgreen}credibility{/}. An "ASP Member"
logo in a program's about screen meant it was real software by a
real developer who would answer your mail.

## CD-ROMs and the golden age

By the early 1990s, shareware had outgrown floppies. {white}
...
## What BBSes actually built

BBSes did not invent shareware. Fluegelman and Knopf invented
the model. What BBSes provided was the {yellow}distribution
...
per title. BBSes gave shareware authors access to {white}millions
of potential users{/} for zero distribution cost.

Every {lightcyan}freemium app{/}, every {lightcyan}free trial{/},
every {lightcyan}open-source project on GitHub{/} sits on a
